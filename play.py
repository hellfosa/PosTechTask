...
loader = DataLoader()
options = Options(connection='local', module_path='library', forks=100, become=None, become_method=None, become_user=None, check=False)
...
play_source =  dict(
        ...
        gather_facts = 'no',
        tasks = [
            dict(action=dict(module='get_version', args=dict(program='libreoffice'))),
         ]
    )
